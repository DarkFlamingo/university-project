...
const TABLE_NAME = TableName.CASES;
...
async function up(knex: Knex): Promise<void> {
  ...
  return knex.schema.createTable(TABLE_NAME, (table) => {
    ...
    table.integer('cooler_count').notNullable();
    table.integer('max_gpu_length').notNullable();
    table.integer('max_cooler_hight').notNullable();
